...
- feat: `auto` mode sends more changes through one-pass generation (about 3 in 10, previously about 2 in 10), trading accuracy in that lane for lower cost and latency. Pin `deep` when every message must follow your template.
