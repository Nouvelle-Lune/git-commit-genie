...
export const L10N_KEYS = {
  ...
  stages: {
    ...
    investigationComplete: 'Repository evidence collection finished…',
    analysisFinalizing: 'Compiling investigation and change analysis…',
    investigationResolved: 'Investigation answers ready…',
